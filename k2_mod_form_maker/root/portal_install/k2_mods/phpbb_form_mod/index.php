...
$logo_img = 'portal_intall/k2_mods/phpbb_form_mod/form_maker_install.png';

include($phpbb_root_path . 'portal_install/k2_mods/phpbb_form_mod/sql_data.' . $phpEx);
...
$versions = array(
	...
	'0.0.1' => array(
		...
		'module_add' => array(
			array('acp', 'ACP_CAT_PORTAL', 'FORM_MAKER'),
